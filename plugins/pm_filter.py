...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
        InlineKeyboardButton(" 𝐒𝐄𝐋𝐄𝐂𝐓 𝐋𝐀𝐍𝐆𝐔𝐀𝐆𝐄 ʕʘ̅͜ʘ̅ʔ", callback_data=f"languages#{key}"),
        ] 
    )
    btn.insert(0,
        [ 
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🧞‍♀️ Search 🧐', url='https://t.me/+4IeN5Jhr22I4ZGVl'),
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/Film_ShowCase')
        ], [
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ to ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/Flimshowcase/8'),
        ] 
    )
