...
ADMIN_USRNM = environ.get('ADMIN_USRNM','ThenameAk') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','FilmShowCase') # WITHOUT @
...
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "Film_ShowCase") #[ without @ ]
