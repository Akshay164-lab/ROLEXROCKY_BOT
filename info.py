...
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','movieluff') # WITHOUT @
...
# Url Shortner
URL_MODE = is_disable(environ.get("URL_MODE","True")), False)
...
DOWNLOAD_TEXT_URL = "https://t.me/Flimshowcase/8"
